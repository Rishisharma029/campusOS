...
class Student(Base):
    ...
    exam_results: Mapped[list["Result"]] = relationship(
        "Result", back_populates="student", cascade="all, delete-orphan"
    )
    fee_collections: Mapped[list["FeeCollection"]] = relationship(
        "FeeCollection", back_populates="student", cascade="all, delete-orphan"
    )
    book_borrows: Mapped[list["BookBorrow"]] = relationship(
        "BookBorrow", back_populates="student", cascade="all, delete-orphan"
    )

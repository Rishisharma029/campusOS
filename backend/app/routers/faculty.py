...
@router.get("/faculty/{id}", response_model=FacultyResponse, summary="Get a faculty profile by ID")
...
@router.put(
    "/faculty/{id}", response_model=FacultyResponse, summary="Update a faculty profile (Admin only)"
)

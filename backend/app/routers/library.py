...
@router.get(
    "/books", response_model=list[BookResponse], summary="Get all books in the library catalog"
)
...
@router.get(
    "/books/{id}", response_model=BookResponse, summary="Get details of a specific book by ID"
)
async def get_book(

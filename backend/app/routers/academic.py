...
@router.get(
    "/departments", response_model=list[DepartmentResponse], summary="Get all academic departments"
)
...
@router.get(
    "/departments/{id}", response_model=DepartmentResponse, summary="Get a department by ID"
)
...
@router.get("/courses", response_model=list[CourseResponse], summary="Get all academic courses")
...
@router.get("/courses/{id}", response_model=CourseResponse, summary="Get a course by ID")
...
@router.get("/subjects", response_model=list[SubjectResponse], summary="Get all academic subjects")
